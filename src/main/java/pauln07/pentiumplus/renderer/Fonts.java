...
import pauln07.pentiumplus.renderer.text.CustomTextRenderer;
...
public class Fonts {
    ...
    private static final File FOLDER = new File(PentiumPlus.FOLDER, "fonts");
    ...
    public static void init() {
        ...
        for (String font : BUILTIN_FONTS) {
            ...
            if (!file.exists()) {
                StreamUtils.copy(Fonts.class.getResourceAsStream("/assets/" + PentiumPlus.MOD_ID + "/fonts/" + font), file);
            }
        }
