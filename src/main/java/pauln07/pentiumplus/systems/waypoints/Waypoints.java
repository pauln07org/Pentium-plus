...
package pauln07.pentiumplus.systems.waypoints;
...
import pauln07.pentiumplus.events.render.Render2DEvent;
...
public class Waypoints extends System<Waypoints> implements Iterable<Waypoint> {
    ...
    @Override
    public void init() {
        File iconsFolder = new File(new File(PentiumPlus.FOLDER, "waypoints"), "icons");
        iconsFolder.mkdirs();
    ...
    public File getFile() {
        ...
        return new File(new File(PentiumPlus.FOLDER, "waypoints"), Utils.getWorldName() + ".nbt");
    }
    ...
    private void copyIcon(File file) {
        StreamUtils.copy(Waypoints.class.getResourceAsStream("/assets/" + PentiumPlus.MOD_ID + "/textures/icons/waypoints/" + file.getName()), file);
    }
}
