...
package pauln07.pentiumplus.systems.modules.movement.elytrafly;
...
import pauln07.pentiumplus.systems.modules.movement.elytrafly.modes.Packet;
import pauln07.pentiumplus.systems.modules.movement.elytrafly.modes.Pitch40;
import pauln07.pentiumplus.systems.modules.movement.elytrafly.modes.Vanilla;
import pauln07.pentiumplus.systems.modules.player.ChestSwap;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        PentiumPlus.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        PentiumPlus.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        PentiumPlus.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        PentiumPlus.EVENT_BUS.unsubscribe(staticInstadropListener);
    }
