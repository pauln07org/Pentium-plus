...
import pauln07.pentiumplus.mixin.CreativeInventoryScreenAccessor;
import pauln07.pentiumplus.mixin.KeyBindingAccessor;
...
public class GUIMove extends Module {
    ...
    private void set(KeyBinding bind, boolean pressed) {
        ...
        if (wasPressed != pressed && key.getCategory() == InputUtil.Type.KEYSYM) {
            PentiumPlus.EVENT_BUS.post(KeyEvent.get(key.getCode(), 0, pressed ? KeyAction.Press : KeyAction.Release));
        }
    }
