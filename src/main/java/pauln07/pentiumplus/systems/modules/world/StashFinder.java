...
import pauln07.pentiumplus.gui.widgets.containers.WVerticalList;
...
import pauln07.pentiumplus.utils.render.MeteorToast;
...
public class StashFinder extends Module {
    ...
    private File getJsonFile() {
        return new File(new File(new File(PentiumPlus.FOLDER, "stashes"), Utils.getWorldName()), "stashes.json");
    }

    private File getCsvFile() {
        return new File(new File(new File(PentiumPlus.FOLDER, "stashes"), Utils.getWorldName()), "stashes.csv");
    }
