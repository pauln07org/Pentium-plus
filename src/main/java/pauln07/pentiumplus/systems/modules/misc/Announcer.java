...
import pauln07.pentiumplus.events.entity.player.BreakBlockEvent;
import pauln07.pentiumplus.events.entity.player.PickItemsEvent;
import pauln07.pentiumplus.events.entity.player.PlaceBlockEvent;
...
public class Announcer extends Module {
    ...
    public void onActivate() {
        for (Feature feature : features) {
            if (feature.isEnabled()) {
                PentiumPlus.EVENT_BUS.subscribe(feature);
                feature.reset();
            }
        }
    }
    ...
    public void onDeactivate() {
        for (Feature feature : features) {
            if (feature.isEnabled()) {
                PentiumPlus.EVENT_BUS.unsubscribe(feature);
            }
        }
    }
