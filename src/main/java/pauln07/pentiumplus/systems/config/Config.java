...
package pauln07.pentiumplus.systems.config;
...
public class Config extends System<Config> {
    ...
    public final Setting<String> font = sgVisual.add(new ProvidedStringSetting.Builder()
        .name("font")
        .description("Custom font to use (picked from .minecraft/" + PentiumPlus.MOD_ID + "/fonts folder).")
    ...
    public final Setting<String> customWindowTitleText = sgVisual.add(new StringSetting.Builder()
        ...
        .defaultValue("Minecraft {mc_version} - Pentium plus {version}")
        .onChanged(value -> mc.updateWindowTitle())
        .build()
    );
    ...
    public NbtCompound toTag() {
        ...
        tag.putString("version", PentiumPlus.VERSION.toString());
