...
public class MeteorStarscript {
    ...
    public static void init() {
        ...
        // General
        ss.set("version", Value.string(PentiumPlus.VERSION != null ? (PentiumPlus.DEV_BUILD.isEmpty() ? PentiumPlus.VERSION.toString() : PentiumPlus.VERSION + " " + PentiumPlus.DEV_BUILD) : ""));
