...
import pauln07.pentiumplus.events.entity.player.ItemUseCrosshairTargetEvent;
import pauln07.pentiumplus.events.game.GameLeftEvent;
import pauln07.pentiumplus.events.game.OpenScreenEvent;
import pauln07.pentiumplus.events.game.ResourcePacksReloadedEvent;
import pauln07.pentiumplus.events.game.WindowResizedEvent;
import pauln07.pentiumplus.events.world.TickEvent;
import pauln07.pentiumplus.gui.WidgetScreen;
import pauln07.pentiumplus.mixininterface.IMinecraftClient;
import pauln07.pentiumplus.systems.config.Config;
import pauln07.pentiumplus.systems.modules.Modules;
import pauln07.pentiumplus.systems.modules.render.UnfocusedCPU;
...
public abstract class MinecraftClientMixin implements IMinecraftClient {
    ...
    private void onInit(CallbackInfo info) {
        PentiumPlus.INSTANCE.onInitializeClient();
        firstFrame = true;
    }
    ...
    private void onPreTick(CallbackInfo info) {
        ...
        PentiumPlus.EVENT_BUS.post(TickEvent.Pre.get());
        getProfiler().pop();
    ...
    private void onTick(CallbackInfo info) {
        ...
        PentiumPlus.EVENT_BUS.post(TickEvent.Post.get());
        getProfiler().pop();
    }
    ...
    private HitResult doItemUseMinecraftClientCrosshairTargetProxy(MinecraftClient client) {
        return PentiumPlus.EVENT_BUS.post(ItemUseCrosshairTargetEvent.get(client.crosshairTarget)).target;
    }
    ...
    private CompletableFuture<Void> onReloadResourcesNewCompletableFuture(CompletableFuture<Void> completableFuture) {
        completableFuture.thenRun(() -> PentiumPlus.EVENT_BUS.post(ResourcePacksReloadedEvent.get()));
    ...
    private void onResolutionChanged(CallbackInfo info) {
        PentiumPlus.EVENT_BUS.post(WindowResizedEvent.get());
    }
